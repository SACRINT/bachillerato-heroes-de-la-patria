...
class AdminAuth {
    ...
    handleLoginError(error) {
        const errorMessage = error.response?.data?.message || 'Error de autenticación. Por favor, intente de nuevo.';
        const schoolName = window.getTenantConfigValue('school_name', 'la institución');
        console.error('Error de autenticación:', error);
        alert(`Error en el inicio de sesión para ${schoolName}: ${errorMessage}`);
    }
