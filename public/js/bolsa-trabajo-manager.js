    ...
    renderizarTabla() {
        ...
        tbody.innerHTML = candidatosFiltrados.map(candidato => `
            <tr>
                <td>${candidato.id}</td>
                <td>
                    <strong>${candidato.nombre_completo || candidato.nombre || 'Sin nombre'}</strong><br>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <table class="table table-sm">
                                        <tr><td><strong>Nombre:</strong></td><td>${candidato.nombre_completo || candidato.nombre || '-'}</td></tr>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <table class="table table-sm">
                                        ...
                                        <tr><td><strong>Experiencia:</strong></td><td>${candidato.experiencia || '-'}</td></tr>
                            ...
                            ${candidato.notas ? `
                                <div class="mt-3">
                                    ...
                                    <div class="alert alert-info">${candidato.notas}</div>
                                </div>
                            ` : ''}
                            ${candidato.cv_url ? `
                                <div class="mt-3">
                                    ...
                                    <p>
                                        ...
                                        <a href="${candidato.cv_url}" target="_blank">Ver CV</a>
                                    </p>
                                </div>
                            ` : ''}
                        </div>
