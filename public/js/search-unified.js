// Sistema de búsqueda unificado y avanzado - window.getTenantConfigValue('school_name', 'window.getTenantConfigValue('school_short_form', 'window.getTenantConfigValue('school_short_form', 'window.getTenantConfigValue('school_short_form', 'window.getTenantConfigValue('school_short_form', 'window.getTenantConfigValue('school_short_form', 'window.getTenantConfigValue('school_short_form', 'BGE Héroes')')')')')') de la Patria')
(function() {
    'use strict';
    ...
    function showUnifiedResults(results, query) {
        ...
        resultsContent.innerHTML = DOMPurify.sanitize(createUnifiedResultsHTML(results, query));
