...
'use strict';
console.log('🚀 [STARTUP] dashboard-manager-2025.js INICIANDO - VERSIÓN ANTI-CACHÉ 2025-09-15 16:30:00');
console.log('🔧 [STARTUP] Verificando timestamp único:', Date.now());
class AdminDashboard {
constructor() {
console.log('🏗️ [CONSTRUCTOR] AdminDashboard iniciando construcción...');
...
console.log('🔧 [DEBUG] Inicializando realDataConfig... [VERSIÓN ACTUALIZADA 2025-09-15 16:30:00]');
...
console.log('⚙️ [DEBUG] realDataConfig inicializado:', this.realDataConfig);
this.init();
setTimeout(() => {
updateRefreshButtonState();
}, 1000);
console.log('✅ [CONSTRUCTOR] AdminDashboard construcción completada');
}
async init() {
...
loadStudentsTable() {
console.log('📊 [DEBUG] loadStudentsTable() iniciado - NUEVA VERSIÓN');
...
console.log('✅ [COMPLETE] dashboard-manager-2025.js cargado completamente - VERSIÓN 2025-09-15 16:30:00');
class CMSManager {
constructor() {
...
console.error(`❌ [CMS] Error cargando ${endpoint}:`, error);
return null;
}
}
...
console.log(`💾 [CMS] Datos guardados en ${endpoint}`);
return true;
} catch (error) {
console.error(`❌ [CMS] Error guardando ${endpoint}:`, error);
return false;
}
}
