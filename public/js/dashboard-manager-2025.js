...
class AdminDashboard {
    ...
    async loadAnalytics() {
        try {
            ...
            const response = await window.apiClient.request('/analytics');
    ...
    async loadStudentsData() {
        try {
            ...
            const response = await window.apiClient.request('/admin/students?limit=10');
    ...
    async loadTeachersData() {
        try {
            ...
            const response = await window.apiClient.request('/admin/teachers?limit=10');
