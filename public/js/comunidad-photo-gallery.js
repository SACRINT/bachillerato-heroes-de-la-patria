/**
 * 📸 PHOTO GALLERY - BGE HEROES DE LA PATRIA
 * Sistema de galería de fotos con modal dinámica
 * Extraído de inline script para CSP compliance
 * Fecha: 18 Nov 2025
 * Usado en: comunidad.html
 */
            ...
            ${photos.map((photo, index) => `
                <div class="col-md-6 col-lg-4">
                    <div class="card h-100">
                        <img src="${photo.src}" alt="${photo.title}" class="card-img-top" style="height: 200px; object-fit: cover;" onerror="this.src='images/galeria/placeholder_actividad2.webp'">
                        <div class="card-body">
