...
class AdvancedLazyLoader {
    ...
    async loadNoticias(element) {
        try {
            ...
            element.innerHTML = DOMPurify.sanitize(this.renderNoticias(noticias.slice(0, 3)), 'ugc');
    ...
    async loadEventos(element) {
        try {
            ...
            element.innerHTML = DOMPurify.sanitize(this.renderEventos(eventos.slice(0, 3)), 'ugc');
            element.classList.add('content-loaded');
