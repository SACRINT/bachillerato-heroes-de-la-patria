...
class AdvancedLazyLoader {
    ...
    async loadContent(element) {
        ...
        try {
            ...
            element.innerHTML = sanitizeHTML('<p class="text-muted">Error cargando contenido</p>');
        }
    }
    ...
    async loadNoticias(element) {
        try {
            ...
            element.innerHTML = sanitizeHTML(this.renderNoticias(noticias.slice(0, 3)));
    ...
    async loadEventos(element) {
        try {
            ...
            element.innerHTML = sanitizeHTML(this.renderEventos(eventos.slice(0, 3)));
            element.classList.add('content-loaded');
