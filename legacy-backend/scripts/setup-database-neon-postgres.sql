-- ============================================
-- 🗄️ SETUP DE BASE DE DATOS PARA NEON POSTGRES
-- Bachillerato General Estatal "Héroes de la Patria"
-- ============================================
--
-- IMPORTANTE: Este script está optimizado para PostgreSQL
-- Compatible con: Neon, Vercel Postgres, Supabase
--
-- DIFERENCIAS CON MYSQL:
-- - SERIAL en lugar de AUTO_INCREMENT
-- - BOOLEAN en lugar de TINYINT
-- - TEXT en lugar de ENUM (con CHECK constraints)
...
-- 🎉 Base de datos PostgreSQL configurada exitosamente
-- ✅ Compatible con: Neon, Vercel Postgres, Supabase
-- ✅ 5 tablas creadas
-- ✅ Índices optimizados
