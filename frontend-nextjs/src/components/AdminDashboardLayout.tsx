...
const adminNavItems = [
    ...
    { label: 'Estudiantes', href: '/dashboard/admin/estudiantes', icon: GraduationCap },
    { label: 'Docentes', href: '/dashboard/admin/docentes', icon: Users },
    { label: 'Académico', href: '/dashboard/admin/academico', icon: BookOpen },
    { label: 'Finanzas', href: '/dashboard/admin/finanzas', icon: DollarSign },
    { label: 'Reportes', href: '/dashboard/admin/reportes', icon: FileText },
    { label: 'Calendario', href: '/dashboard/admin/calendario', icon: Calendar },
...
export default function AdminDashboardLayout({ children }: AdminDashboardLayoutProps) {
    ...
    return (
        <div className="flex h-screen bg-slate-50">
            ...
            <aside
                className={`fixed inset-y-0 left-0 z-50 w-64 transform bg-gradient-to-b from-slate-900 to-indigo-900 transition-transform duration-300 lg:static lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'
                    }`}
            >
                <div className="flex h-16 items-center justify-between border-b border-white/10 px-6">
                    <Link href="/" className="flex items-center gap-2">
                        <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-indigo-400 to-purple-500">
            ...
            <div className="flex flex-1 flex-col overflow-hidden">
                <header className="flex h-16 items-center justify-between border-b bg-white px-4 lg:px-6">
                    <div className="flex items-center gap-4">
                        ...
                        <h1 className="text-xl font-semibold text-gray-900">Panel de Admin</h1>
                    </div>
