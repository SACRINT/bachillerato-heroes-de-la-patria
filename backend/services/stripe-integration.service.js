...
class StripeIntegrationService {
     ...
     * Crear pago OXXO
     */
    async createOxxoPayment(amount, metadata, customerEmail) {
        try {
            // TODO: Usar Stripe real
            // const paymentIntent = await stripe.paymentIntents.create({
            //     amount: amount * 100,
    ...
    async handlePaymentFailed(paymentIntent) {
        ...
        await (0, database_1.executeQuery)(`
            ...
            SET 
                ...
                motivo_fallo = $2
            WHERE stripe_payment_intent_id = $1
        `, [paymentIntent.id, ((_a = paymentIntent.last_payment_error) === null || _a === void 0 ? void 0 : _a.message) || 'Pago rechazado']);
    }
    /**
     * Manejar reembolso
     */
     ...
     */
    async processColegiaturaPayment(metadata) {
        await (0, database_1.executeQuery)(`
            UPDATE colegiaturas
            SET 
                status = 'pagado',
     ...
     */
    async processServicioPayment(metadata) {
        await (0, database_1.executeQuery)(`
     ...
     */
    async processIACoinsPayment(metadata) {
    ...
    async generateReceipt(transactionId) {
        const transaction = await (0, database_1.executeQuery)(`
     ...
     * Enviar recibo por email
     */
    async sendReceiptEmail(transaction) {
...
exports.default = new StripeIntegrationService();
