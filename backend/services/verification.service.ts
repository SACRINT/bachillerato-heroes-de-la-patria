 ...
 */
async function createVerification(formData: FormData): Promise<string> {
    try {
 ...
 */
function getVerification(token: string): VerificationRecord | null {
...
function buildVerificationEmailHTML(formData: FormData, verificationLink: string): string {
    return `
<!DOCTYPE html>
<html>
<head>
...
async function sendAdminNotification(formData: FormData): Promise<void> {
