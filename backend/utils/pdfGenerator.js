...
exports.generateClassAttendancePDF = exports.generateAttendanceReportPDF = exports.generateReportCardPDF = void 0;
...
const generateReportCardPDF = (data, res) => {
    ...
    data.grades.forEach((grade, index) => {
        ...
        doc.text(((_a = grade.parcial1) === null || _a === void 0 ? void 0 : _a.toString()) || '-', colX.p1, currentY + 5);
        doc.text(((_b = grade.parcial2) === null || _b === void 0 ? void 0 : _b.toString()) || '-', colX.p2, currentY + 5);
        doc.text(((_c = grade.parcial3) === null || _c === void 0 ? void 0 : _c.toString()) || '-', colX.p3, currentY + 5);
...
// ============================================
const generateAttendanceReportPDF = (data, res) => {
    const doc = new pdfkit_1.default({ margin: 50, size: 'A4' });
    doc.pipe(res);
    // Header
    ...
    for (let i = 0; i < maxRows; i++) {
        ...
        if (materia.length > 35)
            materia = materia.substring(0, 32) + '...';
    ...
    if (data.records.length > maxRows) {
        doc.fontSize(8).fillColor('#666').text(`... y ${data.records.length - maxRows} registros más`, 50, currentY + 5);
    }
    // Footer
    addFooter(doc);
    // Signatures
...
// ============================================
const generateClassAttendancePDF = (data, res) => {
    const doc = new pdfkit_1.default({ margin: 50, size: 'A4' });
    doc.pipe(res);
    // Header
...
exports.generateClassAttendancePDF = generateClassAttendancePDF;
// Export all functions
exports.default = {
    generateReportCardPDF: exports.generateReportCardPDF,
    generateAttendanceReportPDF: exports.generateAttendanceReportPDF,
    generateClassAttendancePDF: exports.generateClassAttendancePDF
};
