...
// Interfaces para tipos de datos (Mocked structures)
interface GamificationProfile {
    ...
    rank: number;
    badges: Badge[];
    recentAchievements: AchievementEarned[];
    stats: UserStats;
}
 ...
 */
router.get('/profile/:userId', authenticateToken, async (req: Request, res: Response, next: NextFunction) => {
    try {
...
router.get('/leaderboard', authenticateToken, async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const users: any[] = [];  // Datos simulados sin acceso a BD
 ...
 */
router.post('/award-points', authenticateToken, async (req: Request, res: Response, next: NextFunction) => {
    try {
        const authReq = req as AuthenticatedRequest;
 ...
 */
router.get('/achievements', authenticateToken, async (req: Request, res: Response, next: NextFunction) => {
    try {
 ...
 */
router.get('/daily-challenges', authenticateToken, async (req: Request, res: Response, next: NextFunction) => {
    try {
 ...
 */
router.post('/complete-challenge', authenticateToken, async (req: Request, res: Response, next: NextFunction) => {
    try {
        const authReq = req as AuthenticatedRequest;
 ...
 */
router.get('/daily-challenges', async (req: Request, res: Response, next: NextFunction) => {
    try {
