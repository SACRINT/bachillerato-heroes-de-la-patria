...
class TwoFactorDAO {
    ...
    static async save(userId, secret, backupCodes) {
        await pool.query(`INSERT INTO user_2fa (user_id, secret, backup_codes, enabled, created_at) VALUES ($1, $2, $3, false, NOW()) ON CONFLICT (user_id) DO UPDATE SET secret = $2, backup_codes = $3, enabled = false`, [userId, secret, JSON.stringify(backupCodes)]);
    }
