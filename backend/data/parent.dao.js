...
class ParentDAO {
    ...
    static async findByEmail(email) {
        ...
        const result = await (0, database_1.executeQuery)(query, [email.toLowerCase()]);
        return result[0];
    }
    ...
    static async getStudentsByParentId(parentId) {
        ...
        `;
        const result = await (0, database_1.executeQuery)(query, [parentId]);
        return result;
    }
    static async checkPermission(parentId, studentId) {
        ...
        `;
        const result = await (0, database_1.executeQuery)(query, [parentId, studentId]);
        return result[0];
    }
    // ==========================================
...
exports.default = ParentDAO;
module.exports = ParentDAO;
//# sourceMappingURL=parent.dao.js.map