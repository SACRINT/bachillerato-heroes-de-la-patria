/**
 * 📧 SUSCRIPTORES DAO (Data Access Object)
...
class SuscriptoresDAO {
    ...
    static async getByEstado(estado) {
        return await executeQuery('SELECT * FROM suscriptores_notificaciones WHERE estado = $1 ORDER BY fecha_registro DESC', [estado]);
    }
