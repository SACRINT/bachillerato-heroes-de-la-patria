...
-- Esto ayudará a PostgreSQL a utilizar los índices de forma efectiva.
...
SELECT
    ...
    CASE WHEN s.id % 2 = 0 THEN 'masculino'::genero_type ELSE 'femenino'::genero_type END,
...
SELECT 'Datos de prueba agregados exitosamente a estudiantes (1000) y calificaciones (5000).';
