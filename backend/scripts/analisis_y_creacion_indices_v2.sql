-- 🚀 PASO 1: ANÁLISIS DE RENDIMIENTO EN NEON (VERSIÓN 2 - CORREGIDA)
...
-- Esta consulta ha sido corregida para usar las columnas correctas de la tabla 'estudiantes'.
...
WHERE
    e.semestre = 1
GROUP BY
    e.id -- Agrupar por la clave primaria es suficiente y eficiente en PostgreSQL
ORDER BY
    promedio DESC
LIMIT 10;
