...
export interface StudentIdentityInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MINTER_ROLE"
...
export namespace IdentityIssuedEvent {
  export type InputTuple = [student: AddressLike, tokenId: BigNumberish];
  export type OutputTuple = [student: string, tokenId: bigint];
  export interface OutputObject {
    student: string;
    tokenId: bigint;
  }
...
export interface StudentIdentity extends BaseContract {
  connect(runner?: ContractRunner | null): StudentIdentity;
  waitForDeployment(): Promise<this>;

  interface: StudentIdentityInterface;
  ...
  getEvent(
    ...
    IdentityIssuedEvent.InputTuple,
    IdentityIssuedEvent.OutputTuple,
    IdentityIssuedEvent.OutputObject
  >;
  getEvent(
    key: "IdentityRevoked"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "IdentityIssued(address,uint256)": TypedContractEvent<
      IdentityIssuedEvent.InputTuple,
      IdentityIssuedEvent.OutputTuple,
      IdentityIssuedEvent.OutputObject
    >;
    IdentityIssued: TypedContractEvent<
      IdentityIssuedEvent.InputTuple,
      IdentityIssuedEvent.OutputTuple,
      IdentityIssuedEvent.OutputObject
    >;
