...
export interface IACoinInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "DOMAIN_SEPARATOR"
...
export interface IACoin extends BaseContract {
  connect(runner?: ContractRunner | null): IACoin;
  waitForDeployment(): Promise<this>;

  interface: IACoinInterface;
