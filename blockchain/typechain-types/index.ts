...
export type { AcademyCredential } from "./contracts/AcademyCredential";
export { AcademyCredential__factory } from "./factories/contracts/AcademyCredential__factory";
export type { Greeter } from "./contracts/Greeter";
export { Greeter__factory } from "./factories/contracts/Greeter__factory";
export type { IACoin } from "./contracts/IACoin";
export { IACoin__factory } from "./factories/contracts/IACoin__factory";
export type { StudentIdentity } from "./contracts/StudentIdentity";
export { StudentIdentity__factory } from "./factories/contracts/StudentIdentity__factory";
